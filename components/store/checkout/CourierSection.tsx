                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0 pr-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <h4 className="text-[13px] md:text-[14px] font-bold text-neutral-base-900 uppercase tracking-tight truncate">
                                                {opt.courierCode ? `${opt.courierCode.toUpperCase()} - ` : ""}{opt.service}
                                            </h4>
                                        </div>

                                        <div className="flex flex-col gap-1.5">
                                            <p className="text-[11px] md:text-[12px] font-medium text-neutral-base-400 uppercase tracking-widest truncate">
                                                {opt.description || opt.cost[0].note}
                                            </p>
                                            <div className="flex items-center gap-2">
                                                <Clock className="w-3.5 h-3.5 text-neutral-base-300" />
                                                <span className="text-[11px] md:text-[12px] font-bold text-neutral-base-500 uppercase tracking-widest">
                                                    Est: {opt.cost[0].etd ? `${opt.cost[0].etd.replace(" HARI", "").replace(" Hari", "")} Hari` : (isManual ? 'Cek Manual' : 'Menyusul')}
                                                </span>
                                            </div>
                                            <div className="mt-1">
                                                <span className={cn(
                                                    "text-[14px] md:text-[16px] font-medium tabular-nums",
