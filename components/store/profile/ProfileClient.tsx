...
const ChangePasswordForm = dynamic(() => import("@/components/store/auth/ChangePasswordForm"), {
    loading: () => <div className="h-32 w-full animate-pulse bg-neutral-50 rounded-2xl" />
});

export function ProfileSkeleton() {
    return (
        <div className="flex-1 min-w-0">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-4 md:mb-8">
            ...
            <div className="mt-8 bg-white rounded-[24px] md:rounded-[32px] p-6 sm:p-8 md:p-12 border border-neutral-base-100 shadow-sm">
