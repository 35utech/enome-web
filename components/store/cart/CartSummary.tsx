...
export default function CartSummary({
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-xl border-t border-neutral-base-100 p-4 pb-6 lg:hidden shadow-[0_-8px_40px_rgba(0,0,0,0.08)] animate-in slide-in-from-bottom duration-500">
                <div className="max-w-[600px] mx-auto flex items-center justify-between gap-6">
                    <div className="flex flex-col gap-0.5">
                        <span className="text-[11px] font-bold text-neutral-base-400 uppercase tracking-[0.1em] leading-none">Total ({selectedCount} Item)</span>
    ...
    return (
        <aside className="w-full lg:w-[380px] lg:sticky lg:top-28 shrink-0">
            <div className="bg-white border border-neutral-base-100 rounded-[24px] md:rounded-[32px] p-6 md:p-8 shadow-xl shadow-neutral-base-400/5">
                <div className="flex items-center gap-3 mb-8">
                    <div className="w-10 h-10 rounded-2xl bg-amber-50 flex items-center justify-center">
                        <ShoppingBag className="w-5 h-5 text-amber-800" />
                    </div>
                    <h3 className="font-heading text-[22px] md:text-[24px] font-bold text-neutral-base-900 tracking-tight">Ringkasan</h3>
                </div>

                <div className="flex flex-col gap-5 mb-8">
                    <div className="flex justify-between items-center px-1">
                        <span className="text-[11px] font-bold text-neutral-base-400 uppercase tracking-[0.15em]">Subtotal ({selectedCount} item)</span>
                        <span className="text-[14px] font-bold text-neutral-base-900 tabular-nums">
                            {formatCurrency(totalAmount)}
                        </span>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 px-1">
                        <div className="flex justify-between items-end">
                            <span className="text-[12px] font-black uppercase tracking-[0.2em] text-neutral-base-900">Total Tagihan</span>
                            <span className="text-[28px] md:text-[32px] font-bold text-neutral-base-900 tracking-tighter leading-none tabular-nums">
                                {formatCurrency(totalAmount)}
                            </span>
                        </div>
                        <p className="text-[10px] text-neutral-base-400 font-bold italic text-right">*Belum termasuk ongkir</p>
                    </div>
                </div>
                ...
                <button
                    onClick={onCheckout}
                    disabled={selectedCount === 0}
                    className="w-full bg-neutral-base-900 text-white h-14 md:h-16 rounded-[20px] text-[11px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 hover:bg-neutral-base-800 transition-all shadow-2xl shadow-neutral-base-900/10 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed group px-6"
                >
                    Checkout Sekarang
                ...
                <div className="pt-6 border-t border-neutral-base-50 flex items-center justify-around">
                    ...
                    {/* <div className="flex flex-col items-center gap-2">
                        ...
                        <span className="text-[8px] font-black uppercase tracking-[0.2em] text-neutral-base-400">Secure</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
