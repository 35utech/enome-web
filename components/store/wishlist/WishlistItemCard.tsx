    ...
    return (
        ...
        >
            <div className="flex flex-col h-full bg-white transition-all duration-500 ease-out group-hover:-translate-y-1">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <motion.button
                                    ...
                                    disabled={isRemoving}
                                    className="w-8 h-8 flex items-center justify-center rounded-full bg-white/80 backdrop-blur-md shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-white hover:text-red-500 text-neutral-base-400"
                ...
                <Link
                    href={`/products/${item.produk_id}`}
                    className="flex justify-between items-start gap-3 px-1 hover:no-underline"
                >
